...
import { IconSearch, IconBell, IconSettings, IconUserFilled, IconUserExclamation, IconUser, IconUserScan, IconMapPin, IconSchool, IconEdit, IconTrash, IconTrophy } from '@tabler/icons-react';
...
// Fetch the subject list from the API endpoint (e.g., /api/subjects_list)
    ...
    const [assignedBy, setAssignedBy] = useState<'all' | 'teacher' | 'self'>('teacher');
    ...
    const [teacherAssignedVisionCompletesRate, setTeacherAssignedVisionCompletesRate] = useState<number>(0);
    useEffect(() => {
                    ...
                    <div className='container-xl pt-0 pb-4'>
                        ...
                        <div className="row g-4 mb-4">
                            {[
                                ...
                                { title: 'Teacher Assigned Vision Completion Rate', value: teacherAssignedVisionCompletesRate, icon: <IconUser />, color: 'bg-sky-900', suffix: '%'},
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Teacher Assigned Vision Completes Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="card shadow-sm border-0 h-100">
                                            ...
                                            <div style={{ marginBottom: '20px' }}> 
                                                ...
                                                {visionLoading ? (
                                                    ...
                                                    <ReactECharts  option={optionVision} style={{ height: '400px', width: '100%' }} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
