    ...
    const api_startpoint = 'http://152.42.238.141:5000'
    ...
    try {
        ...
        if (response.ok) {
            ...
            // If you prefer re-fetching instead of full reload:
            // await fetchLevels();
        }
    } catch (error) {
    ...
    title: "",
    description: "",
    vision_mcq_points: 0,      // Add this
    vision_text_image_points: 0, // Add this
    jigyasa_points: 0,
    mission_points: 0,
    pragya_points: 0,
    puzzle_points: 0,
    ...
    try {
        ...
        setEditFormValues({
            ...
            vision_mcq_points: level.vision_mcq_points,          // Add this
            vision_text_image_points: level.vision_text_image_points, // Add this
    ...
    setShowEditModal(true);
        ...
        const numericFields = [ 'vision_mcq_points', 'vision_text_image_points','jigyasa_points', 'mission_points', 'pragya_points',
...
<div className="mb-3">
    <label className="form-label">Vision MCQ Points</label>
    <input type="number" className="form-control" value={visionMcqPoints} onChange={(e) => setVisionMcqPoints(Number(e.target.value))} required />
</div>
<div className="mb-3">
    <label className="form-label">Vision Text/Image Points</label>
    <input type="number" className="form-control" value={visionTextImagePoints} onChange={(e) => setVisionTextImagePoints(Number(e.target.value))} required />
</div>
                                                    <div className="mb-3">
...
<div className="mb-4">
    <label className="block mb-1">Vision Text/Image Points</label>
    <input
        type="number"
